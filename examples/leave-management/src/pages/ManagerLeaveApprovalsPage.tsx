...
export function ManagerLeaveApprovalsPage() {
  ...
  const handleApprove = async () => {
    if (approvalForm.setValue && approvalForm.handleSubmit) {
      approvalForm.setValue("ManagerApproved", true);
      // Trigger form submission
      const submitHandler = approvalForm.handleSubmit();
      await submitHandler();
  ...
  const canApprove = (request: LeaveRequest) => {
    ...
    return (
      request.CurrentStatus === "MANAGER_APPROVAL" &&
      request.ManagerApproved === null
    );
  };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {showDetails && selectedRequest && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <Card className="max-w-4xl w-full max-h-[90vh] overflow-y-auto bg-white border shadow-2xl">
              <CardHeader>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedRequest.LeaveDays} days
                          </p>
                        </div>
